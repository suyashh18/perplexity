...
export async function configureTelemetry(client, provider = TELEMETRY_PROVIDER_DEDICATED) {
    ...
    if (typeof provider === "string") {
        ...
        return configureTelemetryForHook(hook, { baseURL: client._baseURL, options: client._options }, { telemetry: providerMode, replaceExisting: true });
    }
